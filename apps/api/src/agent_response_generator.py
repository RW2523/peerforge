    ...
    def generate_response(
        ...
        if material_context:
            ...
            messages.append({
                "role": "system",
                "content": (
                    "YOUR TASK: review the research described in the problem "
                    "statement above — its design, its claims, its likely "
                    "weaknesses — against the standards of your field.\n\n"
                    "Review the WORK, not the format of this session. Do not "
                    "write about what you have or have not been given; that is "
                    "not a review finding and the reader already knows.\n\n"
                    "Because the full manuscript is not in front of you:\n"
                    "- Never cite a page, section, table or figure, and never "
                    "report what 'the authors state' — you would be inventing "
                    "it.\n"
                    "- Real external literature you actually know is fine to "
                    "cite.\n"
                    "- Where you need a specific the statement does not give, "
                    "name that specific — 'the design does not say whether "
                    "allocation was concealed' — and move on to your next "
                    "point. One such gap per turn at most."
                ),
            })
